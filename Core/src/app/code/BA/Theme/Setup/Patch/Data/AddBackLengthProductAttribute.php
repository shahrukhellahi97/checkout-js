...
class AddBackLengthProductAttribute implements DataPatchInterface, PatchRevertableInterface
{
    ...
    public function revert()
    {
        ...
        /** @var EavSetup $eavSetup */
        $eavSetup = $this->eavSetupFactory->create(['setup' => $this->moduleDataSetup]);
        $eavSetup->removeAttribute(\Magento\Catalog\Model\Product::ENTITY, 'back_length');
        $this->moduleDataSetup->getConnection()->endSetup();
    }
