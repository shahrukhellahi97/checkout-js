<?php
namespace BA\Enquiries\Model\Validator;
        ...
        foreach ($this->_rules as $fieldName => $validator) {
            ...
            if (!$validator->isValid($value)) {
                if (!isset($this->_messages[$fieldName])) {
                    $this->_messages[$fieldName] = [];
                }
                
                $this->_messages[$fieldName] = array_merge($this->_messages[$fieldName], array_values($validator->getMessages()));
            }
        }
